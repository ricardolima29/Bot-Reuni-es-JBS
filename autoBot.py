...
while True:
    ...
    if eventos == 'Sim':
        ...
        aut.moveTo(568,1052)#powerpoint
        aut.click()
        time.sleep(2)
        aut.moveTo(181,203)#Seleciona a Apresentação
        aut.doubleClick()
        time.sleep(3)
        aut.moveTo(147,371)#tela2
        aut.click()
        time.sleep(1)
        aut.moveTo(1036,596)
        aut.click()
        ...
        time.sleep(1)
                                                            #abrindo o outlook
        aut.moveTo(1993,906)#abrir o Backup
        aut.click()
        time.sleep(1)
        aut.moveTo(2266,561)
        aut.click()
        ...
        aut.write("linfs01")
        time.sleep(4)
        aut.moveTo(2287,656)                                #reduzir zoon
        aut.click()
        time.sleep(1)
        aut.click()
        time.sleep(1)
